...
import { StyleSheet, Text, View, TextInput,FlatList, ScrollView,
  ActivityIndicator,
...
//   ]
//default coordinates
  const nyCOOR = { lat: 40.728, lng: -73.986};
  ...
  render(){
    const { constraints, mapsLoaded, nyLatLng, markers, searchResults } = this.state;
    const { autoCompleteService, geoCoderService } = this.state; // Google Maps
    //console.log(boba)
    return (
      <ScrollView>
        <Test
